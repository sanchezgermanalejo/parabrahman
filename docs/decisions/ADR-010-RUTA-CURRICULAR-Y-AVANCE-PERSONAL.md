...
2. `/mi-aprendizaje` será la vista personal autenticada con etapa actual, próxima tarea, última tarea aprobada y fecha.
3. El currículo inicial tendrá cinco ciclos, quince etapas y noventa y dos títulos de video definidos como datos tipados y desacoplados de las páginas.
...
- Los 92 títulos son un balizado editorial sujeto a revisión, no 92 lecciones ya producidas.
