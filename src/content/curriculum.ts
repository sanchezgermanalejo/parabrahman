    ...
    stages: [
      {
        ...
        lessons: [
          ...
          planned(
            "presencia-yo-soy",
            "La presencia Yo Soy",
            "Reconocer la presencia consciente anterior a toda identificación.",
          ),
          planned(
            "neti-neti",
            "Neti-neti: la negación de la ilusión",
            "Negar metódicamente toda identificación que no constituye el Sí Mismo.",
          ),
          planned(
            "atman-verdadera-naturaleza",
            "Atman, mi verdadera naturaleza",
            "Reconocer el Atman como la verdadera naturaleza del Sí Mismo.",
          ),
          planned(
            "autorrealizacion-si-mismo",
            "La autorrealización del Sí Mismo",
            "Integrar el recorrido inicial y comprender el significado de la autorrealización.",
          ),
        ],
      },
      {
